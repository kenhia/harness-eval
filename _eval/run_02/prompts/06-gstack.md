/autoplan Build the feedhub service described below, start to finish; after the autonomous planning completes, implement the plan through to the definition of done.

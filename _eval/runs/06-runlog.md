...
- launch: `cd ~/src/ai-agents/harness-eval-runs/06-gstack && env HOME=~/src/ai-agents/harness-eval/_eval/profiles/claude-gstack PATH=$PATH claude --model claude-opus-4-8`

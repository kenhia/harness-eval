...
- launch: `cd ~/src/ai-agents/harness-eval-runs/07-baseline-claude && env HOME=~/src/ai-agents/harness-eval/_eval/profiles/claude-clean PATH=$PATH claude --model claude-opus-4-8`

# Grader prompt — Fable(1): rubric grading, run_03 (Haiku 4.5 tier)
...
all seven, then stop. GPT Sol grades independently; a third session
reconciles.
...
- Never modify run repos; clone to `/tmp/grade-fable1-run03/` to run
  anything.
- **Grading order: 01 → 07** (Sol grades 07 → 01).

## Procedure

1. Per repo, score all 7 dimensions → `$EVAL/_eval/run_03/grades/NN-fable1.md`
